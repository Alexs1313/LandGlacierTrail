import {onboardVisuals} from '../assets/visualRegistry';
import {OnboardingPhase} from '../types/entrySchema';
...
export const onboardPhases: OnboardingPhase[] = [
  ...
  },
  {
    ...
    bodyCopy:
      'Navigate all glacier destinations with an interactive map — tap any pin to preview and plan your route.',
