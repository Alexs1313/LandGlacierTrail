import {FilterSegment, FormationEntry, FormationKind} from '../types/entrySchema';
...
export function filterBySegment(
  ...
  const kindMap: Record<'iceCaves' | 'lagoons', FormationKind> = {
    iceCaves: 'iceCaves',
    lagoons: 'glacierLagoons',
  };
  return entries.filter(e => e.formationKind === kindMap[segment]);
}
